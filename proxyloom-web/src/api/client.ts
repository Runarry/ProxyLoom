...
const messages: Record<string, string> = {
  ...
  BUDGET_EXCEEDED: '当前 UTC 日预算不足，整批测试未创建。请减少对象或下载上限。',
  PROXY_CONNECT_FAILED: '代理连接失败，请检查节点认证、远端状态及完整两跳路径。',
  TARGET_TLS_FAILED: '目标 HTTPS 证书校验失败。', HTTP_EXPECTATION_FAILED: '目标状态或响应内容不符合登记预期。',
  TEST_TARGET_UNAVAILABLE: '独立检查发现目标不可用，本次无法判断节点状态。', INSUFFICIENT_SAMPLE: '样本不足 1 秒或最低字节数，无法给出吞吐结论。',
