...
function credential(file, value) {
  sensitive.push(value);
  writeFileSync(join(secrets, file), value, { flag: 'wx', mode: 0o600 });
}
...
try {
  ...
  credential('db_bootstrap_password', bootstrapPassword);
  credential('db_runtime_password', runtimePassword);
  credential('db_migration_password', migrationPassword);
