...
2026-09-08 更新：下方是第五窗口的历史实现及测试。综合 review 后已移除全局 livePids/inFlight、全局子进程扫描和 `Wait4(-1)`，改为每次 Run 独立进程组及显式日志管道。新增“活动任务收养后代不被其他任务回收”和非 Runner 子进程隔离等回归已通过；最终方案与证据见 [M0 修复与补验](remediation-2026-09-08.md) 和 ADR-0006，历史失败不删除。
