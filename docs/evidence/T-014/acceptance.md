...
2026-09-10 补齐：成功刷新生成关联快照的分页导入预览，manual 确认不重新抓取；失败保留成功数据，新成功刷新或来源编辑使旧待确认批次失效。联合证据见 `docs/evidence/T-019/acceptance.md` 与 `docs/evidence/T-048/source-window/acceptance.md`，下方保留前窗口记录。
